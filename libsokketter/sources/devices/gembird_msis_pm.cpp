...
gembird_msis_pm::gembird_msis_pm()
{
    ...
    m_configuration.type = sokketter::power_strip_type::GEMBIRD_MSIS_PM;
...
auto gembird_msis_pm::initialize(std::shared_ptr<kommpot::device_communication> communication)
    -> bool
{
...
auto gembird_msis_pm::identification() -> const kommpot::usb_device_identification
{
