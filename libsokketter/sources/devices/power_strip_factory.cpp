...
// auto power_strip_factory::create(const sokketter::power_strip &power_strip)
//     -> std::unique_ptr<sokketter::power_strip>
// {
//     switch (power_strip.configuration().type)
//     {
//     /**
//      * Gembird MSIS-PM.
//      */
//     case sokketter::power_strip_type::GEMBIRD_MSIS_PM: {
//         return std::make_unique<gembird_msis_pm>(power_strip);
//     }
//     /**
//      * Gembird MSIS-PM 2.
//      */
//     case sokketter::power_strip_type::GEMBIRD_MSIS_PM_2: {
//         return std::make_unique<gembird_msis_pm_2>(power_strip);
//     }
//     /**
//      * Gembird SIS-PM.
//      */
//     case sokketter::power_strip_type::GEMBIRD_SIS_PM: {
//         return std::make_unique<gembird_sis_pm>(power_strip);
//     }
//     /**
//      * Energenie EG-PMS.
//      */
//     case sokketter::power_strip_type::ENERGENIE_EG_PMS: {
//         return std::make_unique<energenie_eg_pms>(power_strip);
//     }
//     /**
//      * Energenie EG-PMS2.
//      */
//     case sokketter::power_strip_type::ENERGENIE_EG_PMS2: {
//         return std::make_unique<energenie_eg_pms2>(power_strip);
//     }
//     default: {
//         SPDLOG_LOGGER_ERROR(SOKKETTER_LOGGER, "Provided power strip type is not supported: {}!",
//             power_strip.configuration().type);
//         return nullptr;
//     }
//     }
// }
